...
Configured database user with "Atlas admin" privileges
...
Obtained connection string and configured in Render
...
envMONGODB_URI=mongodb+srv://chatapp-admin:***@cluster0.rg8sblv.mongodb.net/chatapp?retryWrites=true&w=majority&appName=Cluster0
...
Service deployed successfully with health check endpoint
...
Environment Variables Set:
envREACT_APP_API_URL=https://chatapp-rmsj.onrender.com/api
CI=false
...
Enabled automatic deployments from main branch
Custom subdomain configured: chatapp-brenda
...
Build Status: Show Image Show Image
